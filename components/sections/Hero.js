	...
	return (
      ...
      <ContentHalf>
        <Title
          ...
          viewport={{ once: true }}
        >
          Bienestar mental, comunidad y autonomía
        </Title>
        <Subtitle
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          viewport={{ once: true }}
        >
          Acompañamos a personas, familias y comunidades para construir vidas dignas, participativas y libres de barreras.
        </Subtitle>
      ...
      <ContentHalf initial={{ opacity: 0, y: 50 }}
          ...
          transition={{ duration: 0.6, ease: 'easeOut' }}
          viewport={{ once: true }}>
        <Image src="/hero.jpg" fill alt="Grupo de gente"/>
      </ContentHalf>
		</Section>
	);
}